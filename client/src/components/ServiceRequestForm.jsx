  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="bg-gray-700 rounded-lg shadow-lg p-8">
        <h2 className="text-2xl font-bold mb-6 text-white">Request New Service</h2>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-end space-x-4">
            <button
              ...
              className="px-6 py-2 border border-gray-500 rounded-lg text-gray-300 hover:bg-gray-600"
            >
              Cancel
            </button>
            <button
